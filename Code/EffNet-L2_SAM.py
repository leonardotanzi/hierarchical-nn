            ...
            for i, (images, labels) in enumerate(loader):
                ...
                with torch.set_grad_enabled(phase == "train"):
                    ...
                    if phase == "train":
                        ...
                        if hierarchical_loss:
                            hierarchical_cc(model(images), labels, np.asarray(coarse_labels), int(num_class / num_superclass), num_superclass,
                                                model, weight_decay1=weight_decay1, weight_decay2=weight_decay2).backward()
                        else:
