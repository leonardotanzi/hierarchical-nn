...
if __name__ == "__main__":
    ...
    fine_labels = train_dataset.targets
    coarse_labels = sparse2coarse(train_dataset.targets)
        ...
        for phase in ["train", "val"]:
            ...
            for i, (images, labels) in enumerate(loader):
                ...
                with torch.set_grad_enabled(phase == "train"):
                    ...
                    loss = criterion(outputs, labels)  #hierarchical_cross_entropy(outputs, labels)
